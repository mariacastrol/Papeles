 ...
 * @author ADOLFO
 */
public class VHJDialogAeronavesManifiestos extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VHJDialogAeronavesManifiestos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VHJDialogAeronavesManifiestos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VHJDialogAeronavesManifiestos dialog = new VHJDialogAeronavesManifiestos(new javax.swing.JFrame(), true);
