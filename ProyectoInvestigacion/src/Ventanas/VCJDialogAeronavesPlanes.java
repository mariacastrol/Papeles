 ...
 * @author ADOLFO
 */
public class VCJDialogAeronavesPlanes extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VCJDialogAeronavesPlanes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableAeronavesPlanes.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        if (!ping.mostrarRegistroEspecifico(jTableAeronavesPlanes,nombreTablaMysql,columnasTablaMysql,pK,campoConsulta)) {
            ...
            jTextFieldBuscarMatricula.setText(null);
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        if (!estanVacios()) {
            ...
            if(!ping.insertarFilaEnTabla(nombreTablaMysql,columnasTablaMysql,valores,mensajeSiRepiteRegistro)){
                ...
                jTextFieldSTipo.setText(jTextFieldAATipo.getText());       
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VCJDialogAeronavesPlanes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VCJDialogAeronavesPlanes dialog = new VCJDialogAeronavesPlanes(new javax.swing.JFrame(), true);
    ...
    public boolean setDatosConexion (String sv, String us, String pw, String dB, String [] cTM, String nTM, String pK, String identificacion) {
