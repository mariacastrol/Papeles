 ...
 * @author ADOLFO
 */
public class VQJDialogPDFPlanes extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VQJDialogPDFPlanes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VQJDialogPDFPlanes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VQJDialogPDFPlanes dialog = new VQJDialogPDFPlanes(new javax.swing.JFrame(), true);
