 ...
 * @author ADOLFO
 */
public class VEJDialogCopilotosPlanes extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VEJDialogCopilotosPlanes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("COPILOTO"));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(jLabelSTLicencia, javax.swing.GroupLayout.PREFERRED_SIZE, 73, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("AGREGAR/ACTUALIZAR COPILOTOS"));
        ...
        jTableCopilotosPlanes.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "LICENCIA", "NOMBRE(S)", "A PATERNO", "A PATERNO", "T LICENCIA"
            }
        ) {
        ...
        jTableCopilotosPlanes.setComponentPopupMenu(jPopupMenu1);
        jTableCopilotosPlanes.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
        jTableCopilotosPlanes.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                jTableCopilotosPlanesMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(jTableCopilotosPlanes);
        if (jTableCopilotosPlanes.getColumnModel().getColumnCount() > 0) {
            jTableCopilotosPlanes.getColumnModel().getColumn(0).setMinWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(0).setPreferredWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(0).setMaxWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(2).setMinWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(2).setPreferredWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(2).setMaxWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(3).setMinWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(3).setPreferredWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(3).setMaxWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(4).setMinWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(4).setPreferredWidth(80);
            jTableCopilotosPlanes.getColumnModel().getColumn(4).setMaxWidth(80);
        }
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        if (!ping.mostrarRegistroEspecifico(jTableCopilotosPlanes,nombreTablaMysql,columnasTablaMysql,pK,campoConsulta)) {
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        if (!estanVacios()) {
            ...
            String mensajeSiRepiteRegistro = "YA EXISTE UN COPILOTO CON ESTE NÚMERO DE LICENCIA";
    ...
    }//GEN-LAST:event_jTableCopilotosPlanesMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VEJDialogCopilotosPlanes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VEJDialogCopilotosPlanes dialog = new VEJDialogCopilotosPlanes(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTableCopilotosPlanes;
    ...
    public boolean setDatosConexion (String sv, String us, String pw, String dB, String [] cTM, String nTM, String pK, String licenciaC) {
    ...
    private void funcionVolver() {
        if (FuncionesGenerales.estaVacioJTextField(jTextFieldSNombreCompleto)) {
            ...
            VJFrameVentanaCapturarModificaciones.jTextField8.setText(jTextFieldSNombreCompleto.getText());
            VJFrameVentanaCapturarModificaciones.jTextField9.setText(jTextFieldSLicencia.getText());
            VJFrameVentanaCapturarModificaciones.jLabel38.setText(jLabelSTLicencia.getText());
            if (nLicencia != null) {
                if (!nLicencia.equals(lic)) {
                    VJFrameVentanaCapturarModificaciones.jTextField8.setForeground(new java.awt.Color(0,100,0));
                    VJFrameVentanaCapturarModificaciones.jTextField9.setForeground(new java.awt.Color(0,100,0));
                    VJFrameVentanaCapturarModificaciones.jLabel38.setForeground(new java.awt.Color(0,100,0));
                } else {
                    VJFrameVentanaCapturarModificaciones.jTextField8.setForeground(Color.BLACK);
                    VJFrameVentanaCapturarModificaciones.jTextField9.setForeground(Color.BLACK);
                    VJFrameVentanaCapturarModificaciones.jLabel38.setForeground(Color.BLACK);
                }
            } else {
                VJFrameVentanaCapturarModificaciones.jTextField8.setForeground(new java.awt.Color(0,100,0));
                VJFrameVentanaCapturarModificaciones.jTextField9.setForeground(new java.awt.Color(0,100,0));
