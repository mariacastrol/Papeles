 ...
 * @author ADOLFO
 */
public class VRJDialogPDFManifiestos extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VRJDialogPDFManifiestos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VRJDialogPDFManifiestos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VRJDialogPDFManifiestos dialog = new VRJDialogPDFManifiestos(new javax.swing.JFrame(), true);
    ...
    private void funcionVolver() {
        if (FuncionesGenerales.estaVacioJTextField(jTextFieldSRutaPDF)) {
            VJFrameVentanaCapturarModificaciones.jLabel39.setEnabled(false);
        ...
        if (rutaOriginal == null) {
            if (FuncionesGenerales.estaVacioJTextField(jTextFieldSRutaPDF)) {
                VJFrameVentanaCapturarModificaciones.jLabel39.setForeground(Color.BLACK);
            } else {
                VJFrameVentanaCapturarModificaciones.jLabel39.setForeground(new java.awt.Color(0,100,0));
            }
        } else {
