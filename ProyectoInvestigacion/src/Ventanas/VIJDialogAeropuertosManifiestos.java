 ...
 * @author ADOLFO
 */
public class VIJDialogAeropuertosManifiestos extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VIJDialogAeropuertosManifiestos(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableAeropuertosManifiestos.setSelectionMode(javax.swing.ListSelectionModel.SINGLE_SELECTION);
    ...
    private void botonAgregarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonAgregarActionPerformed
        if (!estanVacios()) {
            ...
            String mensajeSiRepiteRegistro = "YA EXISTE UN AEROPUERTO CON ESTE CÓDIGO IATA";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VIJDialogAeropuertosManifiestos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VIJDialogAeropuertosManifiestos dialog = new VIJDialogAeropuertosManifiestos(new javax.swing.JFrame(), true);
    ...
    private void arregloTextField() {
        camposTextos[0] = jTextFieldAAIATA;
        camposTextos[1] = jTextFieldAAOACI;
