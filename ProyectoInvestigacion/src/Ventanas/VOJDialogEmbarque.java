 ...
 * @author ADOLFO
 */
public class VOJDialogEmbarque extends javax.swing.JDialog {

    /**
     * Creates new form JDialogEmbarque
     */
    public VOJDialogEmbarque(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VOJDialogEmbarque.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VOJDialogEmbarque dialog = new VOJDialogEmbarque(new javax.swing.JFrame(), true);
    ...
    private final JTextField [] camposTextos = new JTextField[16];
