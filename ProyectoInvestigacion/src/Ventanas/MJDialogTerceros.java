 ...
 * @author ADOLFO
 */
public class MJDialogTerceros extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public MJDialogTerceros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MJDialogTerceros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MJDialogTerceros dialog = new MJDialogTerceros(new javax.swing.JFrame(), true);
    ...
    private void funcionVolver() {
        if (FuncionesGenerales.estaVacioJTextField(jTextFieldSNombreCompleto)) {
            ...
            AJFrameVentanaCapturas.jTextField24.setBackground(new java.awt.Color(153,255,153));
            AJFrameVentanaCapturas.jTextField25.setBackground(new java.awt.Color(153,255,153));            
            this.dispose();  
        }
    }
}
