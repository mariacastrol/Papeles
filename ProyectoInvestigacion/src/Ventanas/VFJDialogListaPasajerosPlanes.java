 ...
 * @author ADOLFO
 */
public class VFJDialogListaPasajerosPlanes extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VFJDialogListaPasajerosPlanes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VFJDialogListaPasajerosPlanes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VFJDialogListaPasajerosPlanes dialog = new VFJDialogListaPasajerosPlanes(new javax.swing.JFrame(), true);
