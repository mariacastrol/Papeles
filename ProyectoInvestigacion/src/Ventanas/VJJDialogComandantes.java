 ...
 * @author ADOLFO
 */
public class VJJDialogComandantes extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VJJDialogComandantes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VJJDialogComandantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VJJDialogComandantes dialog = new VJJDialogComandantes(new javax.swing.JFrame(), true);
