...
public class DJDialogPilotosPlanes extends javax.swing.JDialog {
    ...
    private void jTablePilotosPlanesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTablePilotosPlanesMouseClicked
        if (evt.getClickCount() == 2) {
            funcionSeleccionar();
        } else if (evt.getClickCount() == 3) {
            funcionVolver();
        }
    }//GEN-LAST:event_jTablePilotosPlanesMouseClicked
