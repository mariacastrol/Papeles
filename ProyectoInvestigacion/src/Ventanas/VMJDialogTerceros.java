 ...
 * @author ADOLFO
 */
public class VMJDialogTerceros extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public VMJDialogTerceros(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jTableTercerosOficiales = new javax.swing.JTable();
        ...
        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder("TERCER OFICIAL"));
        ...
        jLabel31.setText("TERCER OFICIAL");
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder("AGREGAR/ACTUALIZAR TERCEROS OFICIALES"));
        ...
        jTableTercerosOficiales.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(jTableTercerosOficiales);
        if (jTableTercerosOficiales.getColumnModel().getColumnCount() > 0) {
            jTableTercerosOficiales.getColumnModel().getColumn(0).setMinWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(0).setPreferredWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(0).setMaxWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(2).setMinWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(2).setPreferredWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(2).setMaxWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(3).setMinWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(3).setPreferredWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(3).setMaxWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(4).setMinWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(4).setPreferredWidth(80);
            jTableTercerosOficiales.getColumnModel().getColumn(4).setMaxWidth(80);
        }
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        int filaSeleccionada = jTableTercerosOficiales.getSelectedRow();
        if (filaSeleccionada >= 0) {    
            String celda = jTableTercerosOficiales.getValueAt(filaSeleccionada,0).toString();
            String celda1 = jTableTercerosOficiales.getValueAt(filaSeleccionada,1).toString();
    ...
    private void jMenuItem3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem3ActionPerformed
        int filaSeleccionada = jTableTercerosOficiales.getSelectedRow();
        if (filaSeleccionada >= 0) {
            String campoBuscar = jTableTercerosOficiales.getValueAt(filaSeleccionada,0).toString();
    ...
    private void jTableTercerosOficialesMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTableTercerosOficialesMouseClicked
        if (evt.getClickCount() == 2) {
            funcionSeleccionar();
        } else if (evt.getClickCount() == 3) {
            funcionVolver();
        }
    }//GEN-LAST:event_jTableTercerosOficialesMouseClicked
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(VMJDialogTerceros.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                VMJDialogTerceros dialog = new VMJDialogTerceros(new javax.swing.JFrame(), true);
    ...
    private javax.swing.JTable jTableTercerosOficiales;
    ...
    public boolean setDatosConexion (String sv, String us, String pw, String dB, String [] cTM, String nTM, String pK, String tercero) {
    ...
    private void funcionVolver() {
        if (FuncionesGenerales.estaVacioJTextField(jTextFieldSNombreCompleto)) {
            ...
            VJFrameVentanaCapturarModificaciones.jTextField24.setText(jTextFieldSNombreCompleto.getText());
            VJFrameVentanaCapturarModificaciones.jTextField25.setText(jTextFieldSLicencia.getText());
            VJFrameVentanaCapturarModificaciones.jLabel52.setText(jLabelSTLicencia.getText());
            if (licenciaT != null) {
                if (!licenciaT.equals(lic)) {
                    VJFrameVentanaCapturarModificaciones.jTextField24.setForeground(new java.awt.Color(0,100,0));
                    VJFrameVentanaCapturarModificaciones.jTextField25.setForeground(new java.awt.Color(0,100,0));
                    VJFrameVentanaCapturarModificaciones.jLabel52.setForeground(new java.awt.Color(0,100,0));
                } else {
                    VJFrameVentanaCapturarModificaciones.jTextField24.setForeground(Color.BLACK);
                    VJFrameVentanaCapturarModificaciones.jTextField25.setForeground(Color.BLACK);
                    VJFrameVentanaCapturarModificaciones.jLabel52.setForeground(Color.BLACK);
                }
            } else {
                VJFrameVentanaCapturarModificaciones.jTextField24.setForeground(new java.awt.Color(0,100,0));
                VJFrameVentanaCapturarModificaciones.jTextField25.setForeground(new java.awt.Color(0,100,0));
