 ...
 * @author ADOLFO
 */
public class QJDialogPDFPlanes extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public QJDialogPDFPlanes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QJDialogPDFPlanes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                QJDialogPDFPlanes dialog = new QJDialogPDFPlanes(new javax.swing.JFrame(), true);
