...
public class QJDialogPDFPlanes extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jTextFieldSRutaPDF.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        ...
        jTextFieldAARutaPDF.setHorizontalAlignment(javax.swing.JTextField.CENTER);
    ...
    private void botonBuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonBuscarActionPerformed
        ...
        if (!ping.mostrarRegistroEspecifico(jTablePDFPlanes,nombreTablaMysql,columnasTablaMysql,pK,campoConsulta)) {
    ...
    private void botonPDFActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonPDFActionPerformed
        ...
        if (fileValue == JFileChooser.APPROVE_OPTION){
            jTextFieldAANombrePDF.setText(fc.getSelectedFile().getName());
            jTextFieldAARutaPDF.setText(fc.getSelectedFile().getAbsolutePath());
        }
    ...
    private void arregloTextField() {
        camposTextos[0] = jTextFieldAARutaPDF;
        camposTextos[1] = jTextFieldAANombrePDF;
    }
