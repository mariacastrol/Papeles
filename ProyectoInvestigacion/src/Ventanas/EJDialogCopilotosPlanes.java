 ...
 * @author ADOLFO
 */
public class EJDialogCopilotosPlanes extends javax.swing.JDialog {

    /**
     * Creates new form JDialogPersonalVuelo
     */
    public EJDialogCopilotosPlanes(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EJDialogCopilotosPlanes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                EJDialogCopilotosPlanes dialog = new EJDialogCopilotosPlanes(new javax.swing.JFrame(), true);
